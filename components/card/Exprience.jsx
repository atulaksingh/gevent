...
function Exprience(props) {
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-b from-[#becf3c]">
          <div className=" flex flex-wrap gap-10 justify-center py-20">
            ...
            <div className=" text-white w-[290px] border-2 border-white py-10">
              <h1 className="flex  justify-center">
                <span className="text-[50px] text-[#D7F205] font-bold">15</span>{" "}
                <span className="font-black">TH</span>
              </h1>
              <div className="text-lg text-center font-bold">
                Years Of Experience
            ...
            <div className=" text-white w-[290px] border-2 border-white py-10">
              <h1 className="flex  justify-center">
                <span className="text-[50px] text-[#D7F205] font-bold">80</span>{" "}
                <span className="font-black">TH</span>
              </h1>
              <div className="text-lg text-center font-bold">
                Years Of Experience
